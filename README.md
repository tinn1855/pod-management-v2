...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/7NvWLhqZ36)
...
```sh
npx nx serve pod-management-v2
```

To create a production bundle:

```sh
npx nx build pod-management-v2
```

To see all available targets to run for a project, run:

```sh
npx nx show project pod-management-v2
```
